...
uses
  ...
  SystemConfigurationFrm in 'SystemConfigurationFrm.pas' {frmSystemConfiguration};
...
begin
      ...
      Result := TfrmSystemConfiguration.Create(Application.MainForm);
      TfrmSystemConfiguration(Result).DLLParameter := _Parameter;
