...
uses
  ...
  SystemSettingFrm in 'SystemSettingFrm.pas' {frmSystemSetting},
  EditProductFrm in 'EditProductFrm.pas' {frmEditProduct},
  EditUnitFrm in 'EditUnitFrm.pas' {frmEditUnit},
  EditUnitPackingFrm in 'EditUnitPackingFrm.pas' {frmEditUnitPacking},
  CdeLIB in '..\LIB\CdeLIB.pas',
  EditProdTypeFrm in 'EditProdTypeFrm.pas' {frmEditProdType},
  EditProdGroupFrm in 'EditProdGroupFrm.pas' {frmEditProdGroup},
  EditWarehouseFrm in 'EditWarehouseFrm.pas' {frmEditWarehouse},
  EditSubStockFrm in 'EditSubStockFrm.pas' {frmEditSubStock},
  EditWarehouseTypeFrm in 'EditWarehouseTypeFrm.pas' {frmEditWarehouseType},
  EditLocationFrm in 'EditLocationFrm.pas' {frmEditLocation},
  EditSupplierFrm in 'EditSupplierFrm.pas' {frmEditSupplier},
  EditIssueReqTypeFrm in 'EditIssueReqTypeFrm.pas' {frmEditIssueReqType},
  EditProjectFrm in 'EditProjectFrm.pas' {frmEditProject},
  EditPositionFrm in 'EditPositionFrm.pas' {frmEditPosition},
  EditPersonnelFrm in 'EditPersonnelFrm.pas' {frmEditPersonnel},
  frmEditCommitteeEdit in 'frmEditCommitteeEdit.pas' {frmEditCommittee},
  STK_LIB in '..\LIB\STK_LIB.pas',
  EditRatePriceFrm in 'EditRatePriceFrm.pas' {frmEditRatePrice},
  EditPayTypeFrm in 'EditPayTypeFrm.pas' {frmEditPayType},
  uEditProductUnit in 'uEditProductUnit.pas' {frmEditProductUnit};
...
begin
    if _EnableSQLDebug then
      ...
      Result := TfrmSystemSetting.Create(Application.MainForm);
      TfrmSystemSetting(Result).DLLParameter := _Parameter;
