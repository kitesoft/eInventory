object frmEditProdGroup: TfrmEditProdGroup
  Left = 439
  Top = 279
  Width = 513
  Height = 215
  Caption = 'frmEditProdGroup'
  Color = clBtnFace
  ...
  object RzPanel1: TRzPanel
    ...
    object btnSaveProdgroup: TRzBitBtn
      Left = 332
      Top = 154
      Width = 80
      Height = 29
    ...
    object btnCancelProdgroup: TRzBitBtn
      Left = 420
      Top = 154
      Width = 80
      Height = 29
      ...
      ParentFont = False
      TabOrder = 1
      OnClick = btnCancelProdgroupClick
      Glyph.Data = {
        36030000424D3603000000000000360000002800000010000000100000000100
        18000000000000030000120B0000120B00000000000000000000FF00FFFF00FF
  ...
  object cdsProdGroup: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 353
    Top = 30
  end
  object dsProdGroup: TDataSource
    DataSet = cdsProdGroup
    Left = 401
    Top = 30
  end
end
