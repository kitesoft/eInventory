...
uses
  ...
  MasterReceiveFrm in 'MasterReceiveFrm.pas' {frmMasterReceive},
  SearchPOforReceiveFrm in 'SearchPOforReceiveFrm.pas' {frmSearchPOforReceive},
...
begin
      ...
      Result := TfrmMasterReceive.Create(Application.MainForm);
      TfrmMasterReceive(Result).DLLParameter := _Parameter;
