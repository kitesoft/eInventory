...
type
  ...
  private
    ...
    procedure SetQuotationCode(const Value: integer);
  ...
  public
    ...
    property QuotationCode : integer read FQuotationCode write SetQuotationCode;
...
procedure TfrmAddProdItem.SetQuotationCode(const Value: integer);
begin
  FQuotationCode := Value;
end;
