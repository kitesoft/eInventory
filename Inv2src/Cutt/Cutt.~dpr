...
uses
  ...
  MasterCuttingFrm in 'MasterCuttingFrm.pas' {frmMasterCutting},
...
begin
      ...
      Result := TfrmMasterCutting.Create(Application.MainForm);
      TfrmMasterCutting(Result).DLLParameter := _Parameter;
