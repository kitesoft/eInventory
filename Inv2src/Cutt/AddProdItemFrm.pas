...
type
  ...
  private
    ...
    procedure SetCuttCode(const Value: integer);
  ...
  public
    ...
    property CuttCode : integer read FCuttCode write SetCuttCode;
...
procedure TfrmAddProdItem.SetCuttCode(const Value: integer);
begin
  FCuttCode := Value;
end;
