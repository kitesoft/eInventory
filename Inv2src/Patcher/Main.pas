  ...
  case step of
    0:begin
         lbMessage.Caption :=
            ...
            ' of '+MODULE_NAME+' Module. It is the product of many months work by the SES developer team. '#10#13 +
    ...
    3:begin
       ...
       lbMessage.Caption :=
          'Thank you for chosen  '+MODULE_NAME+' System by Siam Enterprise Software Dev Group'#10#13+
          'You can visit website to update and find more product.'#10#13#10#13 +
          'http://www.bantung.com'#10#13#10#13#10#13#10#13#10#13#10#13#10#13+
...
begin
  try
    ...
    begin
        ...
        xmlConn.WriteString('AppConfig','APP_PATH','C:\Programfiles\ses\inv2');
        xmlConn.WriteString('AppConfig','APP_DBSERVERIP','127.0.0.1');
        xmlConn.WriteString('AppConfig','APP_DBUSERNAME','root');
        xmlConn.WriteString('AppConfig','APP_PASSWD','123456');
        xmlConn.WriteString('AppConfig','APP_DBNAME','inv2_db');
        xmlConn.WriteString('AppConfig','APP_PORT','3306');
     ...
     _app_port:=xmlConn.ReadString('AppConfig','APP_PORT','');
...
begin
  ...
  SQLConnection.Params.Values['DriverName']:='DevartMySQLDirect';

  SQLConnection.Params.Values['ServerCharSet']:= 'tis620';
  SQLConnection.Params.Values['Server Port']:= _app_port;
  ...
  begin
    if not cdsBrp.fieldByName('ID').IsNull then
    begin
      cdsUpdateBrp.Close;
      cdsUpdateBrp.CommandText:='select * from AppReport where ID='''+trim(cdsBrp.fieldByName('ID').AsString+'''');
      cdsUpdateBrp.Open;
      ...
      begin
        ...
        begin
          ...
          for k := 0 to (cdsBrp.FieldCount - 1) do
             ...
             begin
                      if   UpperCase(trim(cdsBrp.Fields[i].FieldName))<>'ID' then
