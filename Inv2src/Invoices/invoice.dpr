...
uses
  ...
  uMasterInvoice in 'uMasterInvoice.pas' {frmMasterInvoice},
...
begin
      ...
      Result := TfrmMasterInvoice.Create(Application.MainForm);
      TfrmMasterInvoice(Result).DLLParameter := _Parameter;
