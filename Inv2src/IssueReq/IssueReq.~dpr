...
uses
  ...
  MasterIssueReqFrm in 'MasterIssueReqFrm.pas' {frmMasterIssueReq},
...
begin
      ...
      Result := TfrmMasterIssueReq.Create(Application.MainForm);
      TfrmMasterIssueReq(Result).DLLParameter := _Parameter;
