...
uses
  ...
  ContractFrm in 'ContractFrm.pas' {frmContract},
  NewContractFrm in '..\SampleDLL\NewContractFrm.pas' {frmNewContract},
...
begin
      ...
      Result := TfrmContract.Create(Application.MainForm);
