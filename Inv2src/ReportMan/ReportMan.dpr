...
uses
  ...
  uReportManager in 'uReportManager.pas' {frmReportManager};
...
begin
      ...
      Result := TfrmReportManager.Create(Application.MainForm);
      TfrmReportManager(Result).DLLParameter := _Parameter;
