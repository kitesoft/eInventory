...
uses
  ...
  MasterStockFrm in 'MasterStockFrm.pas' {frmMasterStock},
  EditWarehouseProdFrm in 'EditWarehouseProdFrm.pas' {frmEditWarehouseProd};
...
begin
      ...
      Result := TfrmMasterStock.Create(Application.MainForm);
      TfrmMasterStock(Result).DLLParameter := _Parameter;
