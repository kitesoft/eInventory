...
type
  ...
  private
    ...
    procedure SetIssueCode(const Value: integer);
  ...
  public
    ...
    property IssueCode : integer read FIssueCode write SetIssueCode;
...
procedure TfrmAddProdItem.SetIssueCode(const Value: integer);
begin
  FIssueCode := Value;
end;
