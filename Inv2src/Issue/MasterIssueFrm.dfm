object frmMasterIssue: TfrmMasterIssue
  Left = 257
  Top = 150
  Width = 1024
  Height = 563
  Caption = 'frmMasterIssue'
  Color = clBtnFace
  ...
  object pnAllClients: TRzPanel
    ...
    object pnHeader: TRzPanel
      ...
      object lbHeader: TRzLabel
        ...
        Width = 116
        Height = 16
        Caption = #3592#3656#3634#3618#3626#3636#3609#3588#3657#3634' ( Issue )'
        Font.Charset = THAI_CHARSET
        Font.Color = clWhite
        Font.Height = -13
        Font.Name = 'Tahoma'
    ...
    object pgAllClients: TPageControl
      ...
      object tabAllIssueList: TTabSheet
        Caption = #3619#3634#3618#3585#3634#3619#3651#3610#3592#3656#3634#3618#3626#3636#3609#3588#3657#3634
            ...
            object TabIssueList: TRzTabSheet
              ...
              object grdAllIssue: TcxGrid
                ...
                object cxGridDBTableView1: TcxGridDBTableView
                  ...
                  DataController.DataSource = dsAllIssueList
            ...
            object TabIssue: TRzTabSheet
              ...
              object grdIssueList: TcxGrid
                ...
                object cxGridDBTableView3: TcxGridDBTableView
                  ...
                  DataController.DataSource = dsIRIssues
                  DataController.Summary.DefaultGroupSummaryItems = <>
                  DataController.Summary.FooterSummaryItems = <>
                  DataController.Summary.SummaryGroups = <>
                  OptionsData.Deleting = False
              ...
              object grdIssueReqLIST: TcxGrid
                ...
                object cxGridDBTableView4: TcxGridDBTableView
                  DataController.DataSource = dsIssueReqList
                  DataController.Summary.DefaultGroupSummaryItems = <>
                  DataController.Summary.FooterSummaryItems = <>
                  DataController.Summary.SummaryGroups = <>
                  OptionsData.Deleting = False
        ...
        object RzPanel3: TRzPanel
          ...
          object btnNewIssueReq: TRzBitBtn
            Left = 659
            Top = 4
            Width = 157
            Height = 29
            Anchors = [akRight, akBottom]
            Caption = #3651#3610#3592#3656#3634#3618#3651#3627#3617#3656' ('#3651#3610#3586#3629#3648#3610#3636#3585')'
            Color = clSilver
            Font.Charset = THAI_CHARSET
            Font.Color = clWindowText
            Font.Height = -12
      ...
      object TabIssueData: TTabSheet
        Caption = #3651#3610#3592#3656#3634#3618#3626#3636#3609#3588#3657#3634
        ImageIndex = 1
        object RzPanel1: TRzPanel
          ...
          object RzPanel2: TRzPanel
            ...
            object btnSearchIssueReqType: TSpeedButton
              Left = 192
              Top = 76
              Width = 29
              Height = 23
            ...
            object btnSearchJob: TSpeedButton
              Left = 192
              Top = 101
              Width = 29
              Height = 23
            ...
            object RzLabel13: TRzLabel
              ...
              Height = 22
              AutoSize = False
              Caption = ' '#3623#3633#3609#3607#3637#3656#3585#3635#3627#3609#3604#3592#3656#3634#3618#3626#3636#3609#3588#3657#3634
              Color = clSilver
              ParentColor = False
              Layout = tlCenter
              BorderColor = clGray
            ...
            object btnImportFromIssueReq: TRzBitBtn
              ...
              ParentFont = False
              TabOrder = 4
              OnClick = btnImportFromIssueReqClick
              Glyph.Data = {
                36030000424D3603000000000000360000002800000010000000100000000100
                18000000000000030000120B0000120B00000000000000000000FF00FFFF00FF
            ...
            object edIssueReqTypeCode: TRzEdit
              Left = 131
              Top = 76
              Width = 59
              Height = 22
            ...
            object edIssueReqTypeName: TRzEdit
              Left = 222
              Top = 76
              Width = 292
              Height = 22
            ...
            object edIssueReqJobCode: TRzEdit
              Left = 131
              Top = 101
              Width = 59
              Height = 22
            ...
            object edIssueReqJobName: TRzEdit
              Left = 223
              Top = 101
              Width = 292
              Height = 22
          ...
          object RzPanel4: TRzPanel
            ...
            object grdPoItems: TcxGrid
              ...
              object cxGridDBTableView2: TcxGridDBTableView
                ...
                DataController.DataSource = dsIssueDetail
                DataController.Summary.DefaultGroupSummaryItems = <>
                DataController.Summary.FooterSummaryItems = <>
                DataController.Summary.SummaryGroups = <>
                OptionsData.Deleting = False
  ...
  object cdsAllIssueList: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 54
    Top = 310
  end
  object dsAllIssueList: TDataSource
    DataSet = cdsAllIssueList
    Left = 54
    Top = 246
  end
  object dsIssueReqList: TDataSource
    DataSet = cdsIssueReqList
    Left = 166
    Top = 358
  end
  object cdsIssueReqList: TClientDataSet
    Aggregates = <>
    Params = <>
    AfterScroll = cdsIssueReqListAfterScroll
    Left = 166
    Top = 302
  end
  object dsIssueHeader: TDataSource
    DataSet = cdsIssueHeader
    Left = 278
    Top = 342
  end
  object cdsIssueHeader: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 270
    Top = 390
  end
  object dsIssueDetail: TDataSource
    DataSet = cdsIssueDetail
    Left = 374
    Top = 366
  end
  object cdsIssueDetail: TClientDataSet
    Aggregates = <>
    Params = <>
    BeforePost = cdsIssueDetailBeforePost
    Left = 398
    Top = 414
  end
  object dsIssueReqHeader: TDataSource
    DataSet = cdsIssueReqHeader
    Left = 534
    Top = 310
  end
  object cdsIssueReqHeader: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 542
    Top = 350
  end
  object cdsIRIssues: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 70
    Top = 382
  end
  object dsIRIssues: TDataSource
    DataSet = cdsIRIssues
    Left = 70
    Top = 438
  end
