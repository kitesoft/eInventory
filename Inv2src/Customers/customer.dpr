...
uses
  ...
  uMasterCustomer in 'uMasterCustomer.pas' {frmMasterCustomer},
...
begin
      ...
      Result := TfrmMasterCustomer.Create(Application.MainForm);
      TfrmMasterCustomer(Result).DLLParameter := _Parameter;
